...
# MGTREFCLK0_115 (schematic MGT_CLK_2), U2 output 4. EVG1
set_property PACKAGE_PIN H6 [get_ports MGT_CLK_0_P]
set_property PACKAGE_PIN H5 [get_ports MGT_CLK_0_N]

# MGTREFCLK1_115 (schematic MGT_CLK_3), U2 output 5. EVG 2
...
# EXT1_CLK. MGTREFCLK1_116 (schematic MGT_CLK_1), U2 output 1. EVG2
