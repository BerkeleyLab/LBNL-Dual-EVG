...
set_property DRIVE 8 [get_ports PMOD2_0]
set_property SLEW SLOW [get_ports PMOD2_0]
set_property PULLUP true [get_ports PMOD2_0]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS15 DRIVE 16} [get_ports PMOD2_1]
set_property DRIVE 8 [get_ports PMOD2_1]
set_property SLEW SLOW [get_ports PMOD2_1]
set_property PULLUP true [get_ports PMOD2_1]
set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS15 DRIVE 16} [get_ports PMOD2_2]
set_property DRIVE 8 [get_ports PMOD2_2]
set_property SLEW SLOW [get_ports PMOD2_2]
set_property PULLUP true [get_ports PMOD2_2]
set_property -dict {PACKAGE_PIN AF7 IOSTANDARD LVCMOS15 DRIVE 16} [get_ports PMOD2_3]
set_property DRIVE 8 [get_ports PMOD2_3]
set_property SLEW SLOW [get_ports PMOD2_3]
set_property PULLUP true [get_ports PMOD2_3]
