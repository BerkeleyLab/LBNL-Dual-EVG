...
create_clock -period 7.999 -name gtx_ref1 [get_ports MGT_CLK_3_P]
...
set_property LOC SLICE_X86Y182 [get_cells coincidenceRecorder1/genblk2[0].value_a_reg]
set_property LOC SLICE_X87Y182 [get_cells coincidenceRecorder1/genblk2[0].value_m_reg]

set_property LOC SLICE_X86Y181 [get_cells coincidenceRecorder2/genblk2[0].value_a_reg]
set_property LOC SLICE_X87Y181 [get_cells coincidenceRecorder2/genblk2[0].value_m_reg]
...
set_property LOC SLICE_X81Y188 [get_cells coincidenceRecorder1/genblk2[1].value_a_reg]
set_property LOC SLICE_X82Y188 [get_cells coincidenceRecorder1/genblk2[1].value_m_reg]

set_property LOC SLICE_X81Y187 [get_cells coincidenceRecorder2/genblk2[1].value_a_reg]
set_property LOC SLICE_X82Y187 [get_cells coincidenceRecorder2/genblk2[1].value_m_reg]
...
set_max_delay -datapath_only -from [get_clocks gtx_ref0] -to [get_clocks gtx_ref1] 1.0
set_max_delay -datapath_only -from [get_clocks gtx_ref1] -to [get_clocks gtx_ref0] 1.0
...
set_max_delay -datapath_only -from [get_clocks gtx_ref1] -to [get_clocks *evg1mgt/evg1mgt_i/inst/evg1mgt_i/gt0_evg1mgt_i/gtxe2_i/TXOUTCLK] $clk_evg1mgt_0_TXOUTCLK_period
...
set_max_delay -datapath_only -from [get_clocks gtx_ref0] -to [get_clocks *evg2mgt/evg2mgt_i/inst/evg2mgt_i/gt0_evg2mgt_i/gtxe2_i/TXOUTCLK] $clk_evg2mgt_0_TXOUTCLK_period
